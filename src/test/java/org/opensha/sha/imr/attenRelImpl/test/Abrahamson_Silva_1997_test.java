 ...
 * @version 1.0
 */
public class Abrahamson_Silva_1997_test implements ParameterChangeWarningListener {
	...
	public Abrahamson_Silva_1997_test() {
	...
	@Test
	public void testAS1997_Creation() throws IOException {
		...
		//if the all the succeeds and their is no fail for any test
			...
			assertTrue("AS-1997 Test succeeded for all the test cases",result);
		}
	}
	...
	{
		org.junit.runner.JUnitCore.runClasses(Abrahamson_Silva_1997_test.class);
	}
