 ...
 * <p>
 * Note that the HAZ01 IMT format rounds to the nearest 0.1 sec period.
 * TODO: Why is this? Is HAZ01 a standard format or something we can change?
 *       Some of the rounded values result in ConstraintExceptions as not supported by CB_2008_AttenRel.
 * </p>
 * <p>
 * ====== Expected Values ======
 * PGA (HAZ01: PGA)
