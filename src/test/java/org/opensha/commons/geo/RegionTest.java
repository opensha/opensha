...
//		}
		...
		locs.add(new Location(-45.608483145587876,166.230646983058));
		locs.add(new Location(-45.58533011001787,166.19426513655725));
		locs.add(new Location(-45.53036645515403,166.10942039547993));
		locs.add(new Location(-45.518195270549484,166.12566205519335));
		locs.add(new Location(-45.50839528144323,166.15137693160213));
		locs.add(new Location(-45.49719529388855,166.18829392381096));
		locs.add(new Location(-45.48199531077074,166.21141696863884));
		locs.add(new Location(-45.5365,166.2968));
		locs.add(new Location(-45.53650000000001,166.29680000000002));
		locs.add(new Location(-45.53650000000001,166.2968));
		locs.add(new Location(-45.5365,166.29680000000002));
		locs.add(new Location(-45.53650000001627,166.29680000002557));
		locs.add(new Location(-45.590940957467964,166.38234861345467));
		locs.add(new Location(-45.60614094052023,166.3592717909756));
		locs.add(new Location(-45.617340928026536,166.32238888104214));
		locs.add(new Location(-45.627140917090465,166.29670384313485));
...
//		}
	...
	private static double[] regionLocListGreatCircleDat = new double[] {
			...
			-108.49147157035661,35.23841214768841,0.0,
			-107.39360785378389,35.17438358316468,0.0,
			-106.29760527355164,35.10046585780575,0.0,
			-105.20372039707331,35.016703926214404,0.0,
			-105.0,35.0,0.0,
			...
			-105.0,45.0,0.0,
			-106.26441389761405,45.104300219326454,0.0,
			...
			-120.3206658728697,45.31485800032493,0.0,
	...
	private static double[] regionCircularDat = new double[] {
			...
			-129.3553944320109,35.547041982631974,0.0,
	...
	private static double[] regionBufferDat = new double[] {
			...
			-120.05747381869641,42.44153167811818,0.0,
			-120.05747381869642,42.44153167811818,0.0,
			-120.05545155559999,42.44484635641829,0.0,
			-120.04678764913805,42.45419821154589,0.0,
			...
			-118.54484436749891,42.83193463511023,0.0,
			...
			-105.78223895977905,45.708500128529096,0.0,
			...
			-103.79849582519203,45.30130901084314,0.0,
			-103.74416514668954,45.14929587811963,0.0,
			-103.72827305078295,44.99294266417892,0.0,
			-103.75099073605496,44.837014856347054,0.0,
			-103.8113245599498,44.68622670225956,0.0,
			-103.90718203382835,44.545101438075974,0.0,
			-104.03546491535985,44.41784132788407,0.0,
			-104.19218349640474,44.308210453259534,0.0,
			-104.23695860624186,44.28617625557051,0.0,
			-104.23695860624183,44.28617625557051,0.0,
