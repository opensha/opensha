 ...
 * We don't select from a list of parameters, we just see all of the parameters directly.
 *
 * SitesPanel stores a ParameterListEditor siteDataParams;
 * For the "Add Site" button which opens an AddSite panel.
 */
@Deprecated
