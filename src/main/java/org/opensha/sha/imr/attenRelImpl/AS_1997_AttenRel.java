...
public class AS_1997_AttenRel extends AttenuationRelationship {
	...
	public final static Double MAG_WARN_MIN = Double.valueOf(4.5);
	public final static Double MAG_WARN_MAX = Double.valueOf(8);
	public final static Double DISTANCE_RUP_WARN_MIN = Double.valueOf(0.0);
	public final static Double DISTANCE_RUP_WARN_MAX = Double.valueOf(200.0);
...
//		dir.setHorzDistance(100.0); // anything that makes rup dist > 25 km
	...
	protected void initCoefficients() {
		...
		Coefficients coeff1 = new Coefficients(
				"SA/" + (Double.valueOf("4.00")).doubleValue(),
		...
		coeff6 = new Coefficients("SA/" +
				(Double.valueOf("0.85")).doubleValue(),
