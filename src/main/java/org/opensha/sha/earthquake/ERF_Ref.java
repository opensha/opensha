...
public enum ERF_Ref {
	...
	GEM1_SOUTH_AMERICA(GEM1SouthAmericaERF.class, GEM1SouthAmericaERF.NAME, DEVELOPMENT, false),

	/** GEM1 Central/Eastern United States ERF */
	GEM1_CEUS(GEM1_CEUS_ERF.class, GEM1_CEUS_ERF.NAME, DEVELOPMENT, false),

	/** GEM1 Western United States ERF */
	GEM1_WEUS(GEM1_WEUS_ERF.class, GEM1_WEUS_ERF.NAME, DEVELOPMENT, false),

	/** GEM1 GSHAP Africa ERF */
	GEM1_GSHAP_AFRICA(GEM1_GSHAP_Africa_ERF.class, GEM1_GSHAP_Africa_ERF.NAME, DEVELOPMENT, false),

	/** GEM1 GSHAP South/East Asia ERF */
	GEM1_GSHAP_WE_ASIA(GEM1_GSHAP_SE_Asia_ERF.class, GEM1_GSHAP_SE_Asia_ERF.NAME, DEVELOPMENT, false),

	/** GEM1 NSHMP South/East Asia ERF */
	GEM1_NSHMP_WE_ASIA(GEM1_NSHMP_SE_Asia_ERF.class, GEM1_NSHMP_SE_Asia_ERF.NAME, DEVELOPMENT, false),
