...
@AffectsNone
public enum PRVI25_GMM_InterfaceEpistemicModel implements ScalarIMR_ParamsLogicTreeNode {
	...
	private PRVI25_GMM_InterfaceEpistemicModel(PRVI25_GMM_GenericEpistemicModel model) {
		this.model = model;
	}
	...
	public void setParams(ScalarIMR imr) {
		PRVI25_GMM_GenericEpistemicModel.setParams(imr, model.matchStr, TectonicRegionType.SUBDUCTION_INTERFACE);
	}
