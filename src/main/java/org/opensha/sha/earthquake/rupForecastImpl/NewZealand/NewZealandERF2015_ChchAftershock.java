...
/**
 * <p>Title: New Zealand 2015 Eqk Rup Forecast</p>
 * <p>Description: .
 * Earthquake Rupture Forecast for New Zealand using the 2010
 * NSHM (Stirling et al, submitted).  As well as the chch
 * aftershock hazard following Gerstenberger et al (2014) for the 
 * 50 year period from 2015-2065 (as given in BG_FILE_NAME)
 * All other details are as for the 'NewZealandERF2010.java' file
 * </p>
 ...
 * @Date : June, 2014
 * @version 1.1
 * 		changes 1.1 - used modType4 seismicity model which allows for spatially-varying 
 * 					  aftershocks in line with observed seismicity to date.
 */

public class NewZealandERF2015_ChchAftershock extends AbstractERF{

	//for Debug purposes
	private static String  C = new String("NewZealand_ERF_2015ChristchurchAftershock");
	private boolean D = false;
	// name of this ERF
	public final static String NAME = new String("NewZealand_ERF_2015ChristchurchAftershock");


	private final static String FAULT_SOURCE_FILENAME = "/data/erf/new_zealand_2010/NZ_FLTmodel_2010.txt";
	private final static String BG_FILE_NAME = "/data/erf/new_zealand_2010/NZBCK2015_Chch50yearsAftershock_OpenSHA_modType4.txt";
//	private final static String BG_FILE_NAME = "/data/erf/new_zealand_2010/NZ_BKmodeldraft.txt";
	...
	public NewZealandERF2015_ChchAftershock(){	
	...
	public static void main(String[] args) {
		...
		NewZealandERF2015_ChchAftershock nzerf = new NewZealandERF2015_ChchAftershock();
