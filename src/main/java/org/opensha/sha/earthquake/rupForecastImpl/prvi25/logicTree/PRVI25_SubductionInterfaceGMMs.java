...
public enum PRVI25_SubductionInterfaceGMMs implements ScalarIMRsLogicTreeNode.SingleTRT {
	AS_PROVIDED(NshmpGmm.PRVI_2025_INTERFACE, "As Provided", 0.5),
	DATA_ADJUSTED(NshmpGmm.PRVI_2025_INTERFACE_ADJUSTED, "Data Adjusted", 0.5);
	
	private NshmpGmm gmm;
	private String shortName;
	private double weight;

	private PRVI25_SubductionInterfaceGMMs(NshmpGmm gmm, String shortName, double weight) {
		this.gmm = gmm;
