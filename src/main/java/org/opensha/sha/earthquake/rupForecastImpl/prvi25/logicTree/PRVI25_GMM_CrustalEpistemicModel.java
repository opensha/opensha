...
@AffectsNone
public enum PRVI25_GMM_CrustalEpistemicModel implements ScalarIMR_ParamsLogicTreeNode {
	...
	private PRVI25_GMM_CrustalEpistemicModel(PRVI25_GMM_GenericEpistemicModel model) {
		this.model = model;
	}
	...
	public void setParams(ScalarIMR imr) {
		PRVI25_GMM_GenericEpistemicModel.setParams(imr, model.matchStr, TectonicRegionType.ACTIVE_SHALLOW);
	}
