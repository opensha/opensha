...
/**
 * This has the same attributes of its parent (MeanUCERF2), exceept the fault model 2.1 
 ...
 * method of the sister class: MeanUCERF2_FM2pt1.
 */
public class MeanUCERF2_FM2pt2 extends MeanUCERF2 {
	//for Debug purposes
	protected static String  C = new String("MeanUCERF2, FM 2.2");
	// name of this ERF
