 ...
 * 
 * This differs from org.opensha.sha.earthquake.rupForecastImpl.WGCEP_UCERF_2_Final.griddedSeis.Point2Vert_FaultPoisSource
 * only in the following ways:
 * 
 * 1) magFreqDist is passed in as an DiscrtizedFuncAPI because mb-->Mw conversion changes is
 * from and evently discretized MFD.
 * 
 * 2) all depths were set to 5 km.
...
public class CEUS_Point2Vert_FaultPoisSource extends ProbEqkSource implements java.io.Serializable{
	...
	private PointSurface ptSurface; // depth is always 5, no need to create on the fly
	...
	public static void main(String[] args) {
		...
		CEUS_Point2Vert_FaultPoisSource src = new CEUS_Point2Vert_FaultPoisSource(loc, dist,
