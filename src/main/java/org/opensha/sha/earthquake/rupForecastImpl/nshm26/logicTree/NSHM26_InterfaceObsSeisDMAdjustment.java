...
public enum NSHM26_InterfaceObsSeisDMAdjustment implements LogicTreeNode {
	NONE("No Adjustment", "None", 1d/3d),
	AVERAGE("Average Observed Seismicity", "Average", 1d/3d),
	SECTION_SPECIFIC("Section-Specific Observed Seismicity", "Sect-Specific", 1d/3d);
