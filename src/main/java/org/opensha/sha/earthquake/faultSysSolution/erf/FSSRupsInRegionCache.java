...
public class FSSRupsInRegionCache implements RupInRegionCache {
	...
	public boolean isRupInRegion(ERF erf, ProbEqkSource source, EqkRupture rup,
		...
		Preconditions.checkArgument(erf instanceof BaseFaultSystemSolutionERF, "ERF must be a FaultSystemSolutionERF");
		BaseFaultSystemSolutionERF fssERF = (BaseFaultSystemSolutionERF)erf;
