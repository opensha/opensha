...
public class MergedSolutionCreator {
	...
	/**
	 * This merges the given list of fault system solutions into a single solution. It automatically merges any
	 * modules that implement {@link MergeableRuptureModule} or {@link MergeableSolutionModule}.
	 * 
	 * @param sols
	 * @return
	 */
