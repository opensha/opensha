...
public class CS_Study24_8_BasinDepthTo1_0_Servlet extends
		AbstractSiteDataServlet<Double> {
	
	private static final File FILE = new File(ServerPrefUtils.SERVER_PREFS.getTomcatProjectDir(),
			CS_Study24_8_BasinDepth.DEPTH_1_0_FILE);
	
	public CS_Study24_8_BasinDepthTo1_0_Servlet() throws IOException {
		super(new CS_Study24_8_BasinDepth(SiteData.TYPE_DEPTH_TO_1_0, FILE, false));
	}
}
