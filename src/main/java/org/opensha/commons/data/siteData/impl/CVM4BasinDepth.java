...
public class CVM4BasinDepth extends AbstractBinarySiteDataLoader {
	...
	public static final String DEPTH_2_5_FILE = "src"+s+"resources"+s+"data"+s+"site"+s+"CVM4"+s+"depth_2.5.bin";
	public static final String DEPTH_1_0_FILE = "src"+s+"resources"+s+"data"+s+"site"+s+"CVM4"+s+"depth_1.0.bin";
