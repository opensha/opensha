...
public class CS_Study24_8_BasinDepthTo2_5_Servlet extends
		AbstractSiteDataServlet<Double> {
	
	private static final File FILE = new File(ServerPrefUtils.SERVER_PREFS.getTomcatProjectDir(),
			CS_Study24_8_BasinDepth.DEPTH_2_5_FILE);
	
	public CS_Study24_8_BasinDepthTo2_5_Servlet() throws IOException {
		super(new CS_Study24_8_BasinDepth(SiteData.TYPE_DEPTH_TO_2_5, FILE, false));
	}
}
