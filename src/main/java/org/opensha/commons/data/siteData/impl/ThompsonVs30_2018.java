...
public class ThompsonVs30_2018 extends AbstractSiteData<Double> {
	
	public static final int nx = 4993;	// NCOLS
	public static final int ny = 4609;	// NROWS
	
	public static final double spacingX = 0.00208333333306629;
	public static final double spacingY = 0.00208333333304404;
	
	public static final double startLon = -124.500000000333;	// ULXMAP
	public static final double startLat = 42.1000000003335;	// ULYMAP
	...
	public static final String SERVER_BIN_FILE = 
			ServerPrefUtils.SERVER_PREFS.getDataDir().getAbsolutePath()
				...
				+"2018_01_24"+File.separator+"California_vs30_Wills15_hybrid_7p5c.flt";
	
	public static final String SERVLET_URL = ServerPrefUtils.SERVER_PREFS.getServletBaseURL()
			+"SiteData/Thompson2018";
...
//		this(false, "/home/kevin/OpenSHA/wills_2015/raster_0.0005.flt");
	...
	public ThompsonVs30_2018(String dataFile, GeolocatedRectangularBinaryMesh2DCalculator calc)
			throws IOException {
		this(false, dataFile, calc);
	}
	
	private ThompsonVs30_2018(boolean useServlet, String dataFile, GeolocatedRectangularBinaryMesh2DCalculator calc)
			throws IOException {
		super();
	...
	public static ThompsonVs30_2018 fromXMLParams(org.dom4j.Element paramsElem) throws IOException {
	...
	public static void main(String[] args) throws IOException {
		...
		ThompsonVs30_2018 map = new ThompsonVs30_2018(
