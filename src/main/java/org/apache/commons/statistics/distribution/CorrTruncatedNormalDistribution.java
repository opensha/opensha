...
/**
 * TODO: copied from apache commons-statistics master branch after fixing sampling bug (issue 92) and adding
 * parent getters (issue 93). Replace when version 1.3 is released!
 * 
 ...
 */
public final class CorrTruncatedNormalDistribution extends AbstractContinuousDistribution {
     ...
     */
    private CorrTruncatedNormalDistribution(NormalDistribution parent, double z, double lower, double upper) {
     ...
     */
    public static CorrTruncatedNormalDistribution of(double mean, double sd, double lower, double upper) {
        if (sd <= 0) {
        ...
        return new CorrTruncatedNormalDistribution(parent, z, lower, upper);
    }
