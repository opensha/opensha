 ...
 * <p>Description: 	
 * 
 * This is exactly the same as org.opensha.sha.earthquake.rupForecastImpl.WGCEP_UCERF_2_Final.UnsegmentedSource,
 * but where the following line:
 * 			else rupArea  = hb_MagAreaRel.getMedianArea(mag);
 * has been replaced with:
 * 			else rupArea  = (hb_MagAreaRel.getMedianArea(mag)+ellB_magAreaRel.getMedianArea(mag))/2;
 * 
 */
