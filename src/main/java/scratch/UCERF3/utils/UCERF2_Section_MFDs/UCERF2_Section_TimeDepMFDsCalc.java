 ...
 *
 */
public class UCERF2_Section_TimeDepMFDsCalc {
	...
	final static String DATA_SUB_DIR = "UCERF2_Section_TimeDepMFDs";
	...
	final static String MFD_PLOTS_DIR = "dev/scratch/UCERF3/data/scratch/UCERF2_SectionTimeDepMFD_Plots";
...
//	HashMap<String,ArrayList<FaultSectionPrefData>> sectionsForTypeA_RupsMap;
	 ...
	 */
	private UCERF2_Section_TimeDepMFDsCalc(boolean isParticipation) {
...
//		System.out.println(dataDir);
	 ...
	 * UCERF2 section MFD for the specified attributes (over the ?? time-dependent logic tree branches).
	 ...
	 * these are plotted as blue crosses.  
	 * 
...
//				FractileCurveCalculator frCurveCalc = new FractileCurveCalculator(tempMFD_List,mfdWts_ForSectID_Map.get(parID));
			...
			String title;
			if(isParticipation)
				title = sectionNamefromID_Map.get(parID)+" Time-Dep Participation Cum MFDs (totWt="+totWt+")";
			else
				title = sectionNamefromID_Map.get(parID)+" Time-Dep Nucleation Cum MFDs (totWt="+totWt+")";
...
//			gp.saveAsPNG(file.getAbsolutePath()+".png");
	...
	private void makeMFD_Lists() {
		...
		UCERF2_TimeDependentEpistemicList ucerf2EpistemicList = getUCERF2_TimeDependentEpistemicList();
...
//System.exit(1);
		...
		meanUCERF2.setParameter(UCERF2.PROB_MODEL_PARAM_NAME, MeanUCERF2.PROB_MODEL_WGCEP_PREF_BLEND);
